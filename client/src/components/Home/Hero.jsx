...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Organic Background - Using your OKLCH vars */}
      ...
      <div className="container-page grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-10">
          ...
          <div className="hero-text pt-6">
            <ActionLinks role={user?.role} />
          </div>
        </div>

        {/* VISUAL CONTENT (5 Cols) */}
        <div className="lg:col-span-5 relative hero-visual">
          ...
          {/* Floating Specimen Stats */}
          <div className="floating-card glass absolute top-10 right-0 md:-right-10 p-6 rounded-4xl border-white/20 z-20">
